        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    Toast.makeText(PhoneAuthenticationActivity.this,
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            String m_n = firebaseUser.getPhoneNumber();
                            String id = firebaseUser.getUid();


                            String ID = reference.push().getKey();

                            hashMap.put("U_Image",U_Image);
                            hashMap.put("U_Name",U_Name);
                            hashMap.put("U_MobileNumber",m_n);
                            hashMap.put("FirebaseUserID",id);
                            hashMap.put("U_ID",ID);


                            reference.child(id).setValue(hashMap);

                            Intent i = new Intent(PhoneAuthenticationActivity.this, MainActivity.class);
